...
class MovementManager: ObservableObject {
    ...
    private var pitchFilter = EMWAFilter(alpha: 0.1) // Smoothing factor
    private var rollFilter = EMWAFilter(alpha: 0.1) // Smoothing factor
    //private var accelerometerHistory: [SensorData] = []
    //private var gyroscopeHistory: [SensorData] = []
    
    // MARK: - Data from internal sensor
